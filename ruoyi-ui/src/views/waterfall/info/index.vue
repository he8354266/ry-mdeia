        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="封面图片" prop="titleImg">
              <div class="component-upload-image">
                <el-upload :action="uploadImgUrl" list-type="picture-card" :on-success="imgHandleUploadSuccess"
          ...
          <el-col :span="12">
            <el-form-item label="详情图片" prop="imgList">
              <div class="component-upload-image">
                <el-upload :action="uploadImgUrl" list-type="picture-card" :on-success="imgDetailHandleUploadSuccess"
