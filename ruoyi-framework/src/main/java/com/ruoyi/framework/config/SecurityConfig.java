...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity httpSecurity) throws Exception {
    ...
    httpSecurity
        ...
        .antMatchers("/login","/phonelogin/**",  "/sendSms","/getLoginState","/loginBySms","/register", "/captchaImage", "/waterfall/**","/system/**").permitAll()
        .antMatchers("/waterfall/**").anonymous()
        // 静态资源，可匿名访问
        .antMatchers(HttpMethod.GET, "/", "/*.html", "/**/*.html", "/**/*.css", "/**/*.js",
            "/profile/**","/waterfall/**","/system/**").permitAll()
        .antMatchers("/swagger-ui.html", "/swagger-resources/**", "/webjars/**", "/*/api-docs",
            "/druid/**","/waterfall/**","/system/**").permitAll()
        // 除上面外的所有请求全部需要鉴权认证
